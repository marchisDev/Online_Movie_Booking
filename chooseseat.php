...
<section class="mt-5">
    ...
    <div class="container">
        ...
        <a href="nowshowing.php"><button type="button" class="btn btn-success">Re-Select Movie</button></a>
            ...
            <div class="col-md-6">
                <form method="post" class="mt-5">
                    <div class="container">
                        ...
                        <input type="number" name="cust_id" id="cust_id" required value="<?php echo $_SESSION["cust_id"]; ?>">
